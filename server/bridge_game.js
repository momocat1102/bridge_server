...
class game{
    ...
    play = async(mode) => {
        ...
        try{
            ...
            // console.log(this.record.hand_card)
            // console.log(this.record.hand_card.p1_call_handcards, this.record.hand_card.p2_call_handcards)
